...
class _MyAppState extends State<MyApp> {
  File _image;
  List _recognitions;
  String _model = pokedex;
  double _imageHeight;
  double _imageWidth;
  bool _busy = false;
  final picker = ImagePicker();

  /* NOTE: Camera Controller Stream*/
...
// Initialize the CameraController
  ...
  Future recognizeImageBinary(Uint8List imageBytes) async {
    int startTime = new DateTime.now().millisecondsSinceEpoch;
  ...
  Future pokeDex(File image) async {
    int startTime = new DateTime.now().millisecondsSinceEpoch;
    var recognitions = await Tflite.detectObjectOnImage(
      path: image.path,
      numResultsPerClass: 1,
